  ...
  try {
    ...
    const resendRes = await fetch('https://api.resend.com/emails', {
      ...
      body: JSON.stringify({
        ...
        to: email,
        subject: 'Welkom bij Jordan – het CV-platform van Harvest',
        html: `
<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; color: #1a2b4b;">
  <div style="background: #1a2b4b; padding: 24px 32px;">
    <h1 style="color: white; margin: 0; font-size: 22px;">Jordan</h1>
  </div>
  <div style="padding: 32px;">
    <p>Hoi,</p>
    <p>Je bent toegevoegd aan <strong>Jordan</strong>, het CV-platform van Harvest.</p>
    <p>Inloggen gaat eenvoudig:</p>
    <ol>
      <li>Ga naar <a href="https://jordan.vercel.app/login" style="color: #c1272d;">jordan.vercel.app</a></li>
