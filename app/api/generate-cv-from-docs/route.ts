...
- Every work experience entry and every project entry MUST come verbatim from the source documents provided.
...
- This rule overrides all other instructions: if no work experience or projects are present in the source documents, leave those sections empty — do not add examples.
