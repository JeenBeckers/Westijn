...
- Every education entry, work experience entry, and project entry MUST exist verbatim in the source documents provided.
...
- If no work experience or projects are in the source documents, leave those sections empty.
...
- Courses line: ONLY list courses that are explicitly mentioned in the source documents. If no courses are listed, omit the courses line entirely — do NOT infer or invent courses.
- The .kw tags must reflect hard technical skills from that degree. Max 5 tags per entry. Only skills explicitly mentioned in the source.
